...
namespace CurlToCSharp.Services
{
    public class ConverterService : IConverterService
    {
            ...
            statements.AddLast(
                SyntaxFactory.ExpressionStatement(
                    RoslynExtensions.CreateMemberAssignmentExpression(
                        ...
                        RoslynExtensions.CreateInvocationExpression("MediaTypeHeaderValue", "Parse", RoslynExtensions.CreateStringLiteralArgument(curlOptions.GetHeader("Content-Type"))))));
        ...
        private IEnumerable<StatementSyntax> CreateHeaderAssignmentStatements(CurlOptions options)
        {
            ...
            {
                if (string.Equals(header.Key, "Content-Type", StringComparison.InvariantCultureIgnoreCase))
                {
                    continue;
                }
